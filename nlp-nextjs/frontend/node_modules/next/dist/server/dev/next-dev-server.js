        ...
        if ((0, _isError).default(err) && err.stack) {
            try {
                ...
                const frame = frames.find(({ file  })=>{
                    return !(file == null ? void 0 : file.startsWith("eval")) && !(file == null ? void 0 : file.includes("sandbox/context"));
                });
                if (frame.lineNumber && (frame == null ? void 0 : frame.file)) {
                    ...
                    if (originalFrame) {
                        ...
                        if (src === "edge-server") {
                            console[type === "warning" ? "warn" : "error"](`${(type === "warning" ? _chalk.default.yellow : _chalk.default.red)(err.name)}: ${err.message}`);
